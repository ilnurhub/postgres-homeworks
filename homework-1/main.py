...
with psycopg2.connect(
    host="localhost", database="north", user="postgres", password=PSQL_PASSWORD
) as conn:
    with conn.cursor() as cur:
        with open(customers_file_path, encoding="utf-8") as file:
        ...
        with open(employees_file_path, encoding="utf-8") as file:
            data = csv.DictReader(file)
        ...
        with open(orders_file_path, encoding="utf-8") as file:
            data = csv.DictReader(file)
